...
declare distro && set_from_metadata distro 'metadata.instance.operating_system_version.distro' <"$metadata"
declare os_slug && set_from_metadata os_slug 'metadata.instance.operating_system_version.os_slug' <"$metadata"
declare os_codename && set_from_metadata os_codename 'metadata.instance.operating_system_version.os_codename' <"$metadata"
declare preserve_data="false"
declare pwhash && set_from_metadata pwhash 'metadata.instance.crypted_root_password' <"$metadata"
declare hostname && set_from_metadata hostname 'metadata.instance.hostname' <"$metadata"
